...
void run_me()
{
    ...
    SaturationFinder* a = new SaturationFinder(17,0,"All","April","Oct_H2_TS3","/home/rsaradhy/Work/Output/TransitionH_L/Data/data_27_3_2018/H2/"); // 0 implies that it is a allfile which is kept in the root directory...
    // SaturationFinder* a = new SaturationFinder(20,0,"All","April","Oct_H6","/home/rsaradhy/Work/Output/TransitionH_L/Data/data_27_3_2018/H6/"); // 0 implies that it is a allfile which is kept in the root directory...
    ...
    a->dataExtractor(0); //Available Options are :: 0->TS3  1->TS3withCM   2->PFA
